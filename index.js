...
audio35 = fs.readFileSync('./X4/nyz35.m4a') 
			...
			if (!packname) packname = 'Rinz Bot'; if (!author) author = ' Rinz Pendragon';
            ...
            reply("Nomer Owner Ganz Waipu Keking")
            } 
            ...
            reply(mess.wait)
            nay2 = await fetchJson(`https://rinz-api.herokuapp.com/api/nsfw/yuri?apikey=Alphabot`)
            ...
            case 'blowjob-nsfw':
                        if (isGroup) return reply("SILAHKAN GUNAKAN FITUR INI DI PESAN PRIBADI")
            reply(mess.wait)
            nay2 = await fetchJson(`https://rinz-api.herokuapp.com/api/nsfw/blowjob?apikey=Alphabot`)
            nay3 = await getBuffer(nay2.result)
            sendImage(nay3, "NIHH KAK")
            break 
            case 'neko-nsfw':
            if (isGroup) return reply("SILAHKAN GUNAKAN FITUR INI DI PESAN PRIBADI")
            reply(mess.wait)
            nay2 = await fetchJson(`https://rinz-api.herokuapp.com/api/nsfw/nsfwNeko?apikey=Alphabot`)
            nay3 = await getBuffer(nay2.result)
            sendImage(nay3, "NIHH KAK")
            break 
            ...
            break
            case 'caklontong':
            nay2 = await fetchJson(`https://rinz-api.herokuapp.com/api/kuis/caklontong?apikey=Alphabot`) 
            ...
            reply(mess.wait)
            try{
            nay2 = await fetchJson(`https://rinz-api.herokuapp.com/api/asupan/cecan?apikey=Alphabot`)
            nay3 = await getBuffer(nay2.result.url)
            ...
            reply(mess.wait)
            try{
            nay2 = await fetchJson(`https://rinz-api.herokuapp.com/api/asupan/ukty?apikey=Alphabot`)
            nay3 = await getBuffer(nay2.result.url)
            sendVideo(nay3, "NEH KAK")
            } catch (e) { reply("ERROR")}
            break
            ...
            reply(mess.wait)
            try{
            nay2 = await fetchJson(`https://rinz-api.herokuapp.com/api/asupan/rikagusriani?apikey=Alphabot`)
            nay3 = await getBuffer(nay2.result.url)
            sendVideo(nay3, "NEH KAK")
            } catch (e) { reply("ERROR")}
            break                                               
            ...
            reply(mess.wait)
            try{
            nay2 = await fetchJson(`https://rinz-api.herokuapp.com/api/asupan/ghea?apikey=Alphabot`)
            nay3 = await getBuffer(nay2.result.url)
            sendVideo(nay3, "NEH KAK")
            } catch (e) { reply("ERROR")}
            break        
            ...
            reply(mess.wait)
            try{
            nay2 = await fetchJson(`https://rinz-api.herokuapp.com/api/asupan/bocil?apikey=Alphabot`)
            nay3 = await getBuffer(nay2.result.url)
            sendVideo(nay3, "NEH KAK")
            } catch (e) { reply("ERROR")}
            break               
